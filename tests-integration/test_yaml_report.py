...
class TestYamlReport(unittest.TestCase):

    def test_yaml_report_to_stdout(self):
        data = {
    ...
    def test_yaml_report_to_file(self):
        data = {
            "Name": ["Barkley", "Pippen", "Robinson"],
            "DOB": ["19630220", "19650925", "19650806"],
            "City": ["Philadelphia", "Chicago", "San Antonio"],
        ...
        pandas_reporter = PandasReporter()
        _opts = {
            "out_file": "stage/test-integration/test_yaml_report_output.html",
        }
